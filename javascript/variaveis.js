...
alert ('Estamos calculando seu IMC...');

let resultadoExposto = document.getElementById ('calculo');
let nomeDigitado = document.getElementById ('nome');
let pesoDigitado = document.getElementById ('peso');
let alturaDigitada = document.getElementById ('altura')
